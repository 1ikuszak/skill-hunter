...
export const PriceInput = () => {
    return(
        <>
        <div className='mb-6 flex flex-col w-[220px]'>
            <label className="mb-1 text-gray-700 text-m" htmlFor="price">
                Price
            </label>   
            <div class="flex">
                <span class="inline-flex items-center px-4 py-1 text-m text-gray-400 bg-light border border-gray-300 rounded">
                    <svg width="10" className="fill-gray-400" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input type="number" name="time" id="price" class="w-full px-3 px-4 py-3 leading-tight text-gray-700 border border-transparent rounded bg-light focus:outline-none focus:bg-white focus:border-secondary placeholder:text-sm" placeholder="enter price"/>
            </div>
        </div>
        </>
    )
